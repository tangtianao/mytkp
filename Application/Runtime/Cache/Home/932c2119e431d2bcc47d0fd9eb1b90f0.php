      ...
      <link type="text/css"  rel="stylesheet" href="http://localhost:8080/mytyk/Public/easyui/themes/bootstrap/easyui.css">
		...
		$(function(){
			...
			$('#dg').datagrid({
				striped:true,    
				method:'GET',
			    url:"http://localhost:8080/mytyk/index.php/Home/Menu/loadMenuByPag/pageNo/1/pageSize/10",
			    rownumbers:true,
			    pagination: true,
			    frozenColumns:[[
			    ...
			    toolbar: [{
					...
					handler: function(data){
						$("#ff").form('reset');
						$('#parentid').combobox({    
    					    url:"http://localhost:8080/mytyk/index.php/Home/Menu/load12Menu",    
    					    valueField:'menuid',    
    					    textField:'name'   
    					});
					...
					handler: function(){
						...
						if(window.confirm("你真的确定删除这些数据吗？")){
							...
							$.post("http://localhost:8080/mytyk/index.php/Home/Menu/cancelMenu",{
					...
					handler: function(){
						...
						$("#ff").form('reset');
						$.getJSON("http://localhost:8080/mytyk/index.php/Home/Menu/loadMenuByID/menuid/"+row.menuid,{},function(data){
		...
		function refres(pageNumber,pageSize){
			$("#dg").datagrid('loading');
			$.getJSON("http://localhost:8080/mytyk/index.php/Home/Menu/loadMenuByPag/pageNo/"+pageNumber+"/pageSize/"+pageSize,{
		...
		function upMenu(){
			...
			$.post("http://localhost:8080/mytyk/index.php/Home/Menu/addMenu",{
				"name"		:name,
				"url"		:url,
				"parentid"	:parentid,
				"isshow"	:isshow,
